...
const GridLayout = ({minWith, children, className, gridRowGap = "10px", gridColumnGap = "5px", itemMinWith, itemMaxWith, itemWith="400px"}:IAdaptivGridProps)=>{
	...
	return(
	<div style={{minWidth:minWith}} ref={root} className = {`adaptiv-grid-layout ${className}`}>
	  {children}
	</div>
	)
}
